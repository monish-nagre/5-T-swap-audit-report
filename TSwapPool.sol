...
contract TSwapPool is ERC20 {
    ...
    // @audit-info 3 events should be indexed if their are more then 3 parameters
    event Swap(
    ...
    function deposit(
        ...
        uint256 minimumLiquidityTokensToMint,
        uint256 maximumPoolTokensToDeposit,
        uint64 deadline   //@audit : Missing deadline check below, causing transaction to complete even after the deadline 
    )
        external
    ...
    function _addLiquidityMintAndTransfer(
        ...
        // @audit Low - protpcol is giving the wrong return 
        // LiquidityAdded(msg.sender, wethToDeposit, poolTokensToDeposit); should be like this...
...
// isme input token Amount dunga and kitna output aayega yeh hai 
     ...
     */
     ...
     // output me jitna chaye parameter me bhej dunga , then input kitna lagega samjhga 
...
// @audit breaks protocol invariants 
        swap_count++;
